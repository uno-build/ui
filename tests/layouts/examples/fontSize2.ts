...
const TEST_CASES = [
    ...
    { label: 'Stroke · 1px', font_size: 64, text_stroke: '2px #dc2626' },
    { label: 'Stroke · 2px', font_size: 64, text_stroke: '4px #dc2626' },
    { label: 'Stroke · 3px', font_size: 64, text_stroke: '6px #dc2626' },
