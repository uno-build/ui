...
export function makePanelSpherecast(
    ...
    return (sphere, intersects) => {
        ...
        sphereHelper
            .copy(globalSphereWithLocalScale)
        ...
        vectorHelper
            .copy(sphere.center)
            .applyMatrix4(matrixHelper.copy(object.matrixWorld).invert())
 ...
 */
export function makeClippedCast<
    T extends Mesh['raycast'] | Exclude<Mesh['spherecast'], undefined>,
>(
    component: Component,
    fn: T,
    root: Signal<RootContext>,
    ...
    return (
        raycaster: Parameters<T>[0],
        intersects: Parameters<T>[1],
    ): unknown => {
