import { BufferAttribute, PlaneGeometry, TypedArray } from 'three/webgpu'
import { clamp } from 'three/src/math/MathUtils.js'

export type Constructor<T> = new (...args: any[]) => T
export type FirstConstructorParameter<T extends new (...args: any[]) => any> =
    T extends new (property: infer P, ...args: any[]) => any ? P : never
...
export function setComponentInFloat(
    from: number,
    index: number,
    value: number,
): number {
