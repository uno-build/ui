...
import { Matrix4, Quaternion, Vector2Tuple, Vector3 } from 'three/webgpu'
...
export type TextOutProperties = BaseOutProperties &
    AdditionalTextDefaults & { text?: unknown }
...
> extends Component<OutProperties> {
    ...
    readonly backgroundGroupDeps: ReturnType<
        typeof computedPanelGroupDependencies
    >
    ...
    constructor(
        ...
        this.backgroundGroupDeps = computedPanelGroupDependencies(
            this.properties,
        )
        ...
        const fontFamilies = computedFontFamilies(
            this.properties,
        ...
        abortableEffect(
            () => this.node.setCustomLayouting(customLayouting.value),
            this.abortSignal,
        )
    }
