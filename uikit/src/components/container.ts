...
import { Matrix4, Vector2Tuple, Vector3, Vector2 } from 'three/webgpu'
...
> extends Component<OutProperties> {
    ...
    constructor(
        ...
        const scrollHandlers = signal<ScrollEventHandlers | undefined>(
            undefined,
        )
        ...
        this.fontFamilies = computedFontFamilies(
            this.properties,
        ...
        this.anyAncestorScrollable = computedAnyAncestorScrollable(
            this.parentContainer,
        )
