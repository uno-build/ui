import { FrontSide, Material, Texture, Vector4 } from 'three/webgpu'
...
export function createWebGPUImageMaterial(
    ...
    const material = createWebGPUBaseNodeMaterial(
        materialClass,
    ) as NodeMaterial & WebGPUImageMaterial

    const dataRows: PanelDataRows = [
        new Vector4(),
        new Vector4(),
        new Vector4(),
        new Vector4(),
    ...
    const clippingRows: ClippingRows = [
        new Vector4(),
        new Vector4(),
        new Vector4(),
        new Vector4(),
    ...
    const imageSurface = Fn(() => {
        ...
        const fullBackgroundOpacity = sampled.a.mul(background.w).toVar()
