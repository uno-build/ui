...
import { Texture, TypedArray } from 'three/webgpu'
    ...
    effect(() => {
        ...
        if (typeof fontWeight === 'string') {
            ...
            if (isNaN(fontWeight)) {
                ...
                fontWeight =
                    fontWeightNames[fontWeight as keyof typeof fontWeightNames]
            }
        }
        ...
        if (fontFamilyWeightMap == null) {
            ...
            fontFamilyWeightMap =
                fontFamilies[availableFontFamilyList[0] as any]!
            console.error(
...
function getMatchingFontUrl(
    fontFamily: FontFamilyWeightMap,
    weight: number,
): string | FontInfo {
