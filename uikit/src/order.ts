...
import { Object3D, RenderItem } from 'three/webgpu'
...
export const reversePainterSortStableCacheKey = Symbol(
    'reverse-painter-sort-stable-cache-key',
)
...
export function compareOrderInfo(
    o1: OrderInfo | undefined,
    o2: OrderInfo | undefined,
): number {
    if (o1 == null || o2 == null) {
        return 0
    }
...
export function setupOrderInfo(
    ...
    abortableEffect(() => {
        ...
        const majorIndex =
            properties.value[zIndexKey as 'zIndex'] ??
            basisOrderInfo?.majorIndex ??
            0
