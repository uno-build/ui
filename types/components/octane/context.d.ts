...
export const UI_CONTEXT: import("octane/universal/native").NativeUniversalContext<import("../../core/UI").default<import("../../core/Renderer").default<unknown, unknown, unknown, unknown>, import("../../core/Resources").default<unknown, import("../../core/Resources").ResourceTypes>> | null>;
