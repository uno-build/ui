...
function normalizeLineStartSegmentIndex(
  ...
  segmentIndex: number,
  endSegmentIndex: number = prepared.widths.length,
): number {
...
function walkPreparedLinesSimple(
  ...
  function emitCurrentLine(
    endSegmentIndex: number = lineEndSegmentIndex,
    endGraphemeIndex: number = lineEndGraphemeIndex,
    width: number = lineW,
  ): void {
    lineCount++
    onLine?.(
...
function stepPreparedChunkLineGeometry(
  ...
  function finishLine(
    endSegmentIndex: number = lineEndSegmentIndex,
    endGraphemeIndex: number = lineEndGraphemeIndex,
    width: number = getCurrentLinePaintWidth(),
  ): number | null {
