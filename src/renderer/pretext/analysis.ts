...
function getWhiteSpaceProfile(whiteSpace?: WhiteSpaceMode | undefined): WhiteSpaceProfile {
...
export function analyzeText(
  text: string,
  profile: AnalysisProfile,
  whiteSpace: WhiteSpaceMode | undefined = 'normal',
  wordBreak: WordBreakMode | undefined = 'normal',
): TextAnalysis {
