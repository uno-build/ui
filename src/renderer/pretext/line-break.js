...
/**
 * @param {number} leadingSpacing
 * @param {number} segmentContribution
 * @returns {number}
 */
...
/**
 * @param {PreparedLineBreakData} prepared
 * @param {number} candidatePaintWidth
 * @returns {number}
 */
...
/**
 * @param {number[]} preferredBreaks
 * @param {number} preferredBreakIndex
...
export function walkPreparedLinesRaw(
  ...
  /**
   * @param {{ startSegmentIndex: number, consumedEndSegmentIndex: number }} chunk
   * @returns {void}
   */
