...
export function placeGlyphs({
    ...
    run_index,
    text_shadow,
}: { prepared_text: any; text_layout: any; font: any; font_size: any; line_height: any; baseline_y: any; content_x: any; content_width: any; text_align: any; space_advance: any; grapheme_segmenter: any; run_index: any; text_shadow: any; }) {
...
function getTabAdvance(line_width: any, tab_stop_advance: any) {
...
function getTextAlignOffset(text_align: any, content_width: any, line_width: any) {
...
function getTextAlignmentWidth(line: any, space_advance: any, letter_spacing: any) {
...
function getJustifyData(text_align: any, prepared_text: any, line: any, content_width: any, line_width: any) {
...
function isParagraphEnd(prepared_text: any, line: any) {
