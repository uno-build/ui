...
export class ImageManager {
    ...
    imageUpload(src, image) {
        ...
        /**
         * @type {ManagedAtlasImage}
         */
        const new_atlas_image = {
            src,
    ...
    /** @private */
    allocateAtlasRect(width, height) {
        for (const atlas_layer of this.atlas_layers) {
    ...
    /** @private */
    tryAllocateAtlasRect(atlas_layer, width, height) {
    ...
    /** @private */
    createAtlasTexture(layer_count) {
    ...
    /** @private */
    copyImagePadding(image, texture, x, y, layer) {
     ...
     */
    createAtlasUvRect(x, y, width, height) {
