...
export function writeCommandData({ floats, u32 }: { floats: Float32Array; u32: Uint32Array; }, bytes_offset: number, command: any) {
...
export function writePanelData({ floats, u32 }: { floats: Float32Array; u32: Uint32Array; }, bytes_offset: number, panel: any) {
...
export function writeGlyphData({ floats, u32 }: { floats: Float32Array; u32: Uint32Array; }, bytes_offset: number, glyph: any) {
...
export function writeTextRunData({ floats }: { floats: any; }, bytes_offset: number, text_run: any) {
    const {
        color,
        font_data,
        clipping,
